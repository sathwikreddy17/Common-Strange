    ...
    <header className="sticky top-0 z-50 border-b border-zinc-200 bg-white/95 backdrop-blur-sm">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <nav className="hidden items-center gap-6 text-sm md:flex">
          <Link href="/categories" className="text-zinc-600 hover:text-zinc-900 transition-colors">
            Categories
          </Link>
          <Link href="/series" className="text-zinc-600 hover:text-zinc-900 transition-colors">
            Series
          </Link>
          <Link href="/authors" className="text-zinc-600 hover:text-zinc-900 transition-colors">
            Authors
          </Link>
          {user ? (
            <>
              ...
              <Link
                href="/account"
                className="text-zinc-600 hover:text-zinc-900 transition-colors flex items-center gap-1"
              >
